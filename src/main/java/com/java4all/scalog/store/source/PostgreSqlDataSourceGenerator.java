...
import static com.java4all.scalog.configuration.Constants.DEFAULT_POSTGRESQL_DRIVER_CLASS_NAME;
...
public class PostgreSqlDataSourceGenerator implements SourceGenerator{
    ...
    public Object generateSource() {
        ...
        dataSource.setUrl(
                SpringCloudConfig.getConfig(SPRING_DATASOURCE+DELIMITER+URL,DEFAULT_MYSQL_URL));
        ...
        dataSource.setDriverClassName(SpringCloudConfig.getConfig(SPRING_DATASOURCE+DELIMITER+DRIVER_CLASS_NAME,DEFAULT_POSTGRESQL_DRIVER_CLASS_NAME));
        return dataSource;
    }
}
