...
public class PostgreSqlDataSourceGenerator implements SourceGenerator{
    ...
    public Object generateSource() {
        ...
        dataSource.setUrl(
                SpringCloudConfig.getConfig(SCALOG+DELIMITER+URL,DEFAULT_MYSQL_URL));
        ...
        dataSource.setDriverClassName(SpringCloudConfig.getConfig(SCALOG+DELIMITER+DRIVER_CLASS_NAME2,DEFAULT_POSTGRESQL_DRIVER_CLASS_NAME));
        return dataSource;
    }
}
